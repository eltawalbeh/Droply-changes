...
const page=(key:keyof typeof pages)=>{const [title,description]=pages[key];return <StationAdminPage title={title} description={description}/>}

export const router=createBrowserRouter([
  {path:'/',element:<Navigate to="/station-admin" replace/>},
  {path:'/station-admin',element:<DashboardLayout/>,children:[
