      ...
      <div className="grid min-h-screen grid-cols-[260px_minmax(0,1fr)]">
        ...
        <main className="min-w-0">
          <header className="flex h-16 items-center justify-between border-b border-slate-200 bg-white px-8">
            <div>
              <p className="text-sm font-medium text-slate-700">Water Station Admin</p>
              <p className="text-xs text-slate-400">Live station identity appears after tenant data loads.</p>
            </div>
            <div className="rounded-lg border border-slate-200 px-3 py-2 text-xs text-slate-500">JOD</div>
          </header>
